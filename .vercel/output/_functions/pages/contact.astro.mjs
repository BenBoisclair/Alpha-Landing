...
const $$Contact = createComponent(($$result, $$props, $$slots) => {
  ...
  const translations = {
    th: thTranslations,
    en: thTranslations
    // Fallback, but this page is Thai-only
  };
...
}, "/Users/benedictboisclair/Projects/Alpha/src/pages/contact.astro", void 0);

const $$file = "/Users/benedictboisclair/Projects/Alpha/src/pages/contact.astro";
const $$url = "/contact";
